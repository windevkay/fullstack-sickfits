...
function (_Component) {
  ...
  function UpdateItem() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleUpdate",
    /*#__PURE__*/
    function () {
      var _ref = _asyncToGenerator(
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee(e, updateItem) {
        var res;
              ...
              case 0:
                ...
                return updateItem({
                  variables: _objectSpread({
                    //redeclare variables in other to add ID to state
                    id: _this.props.id
                  }, _this.state)
                });
        ...
        return external_react_default.a.createElement(external_react_apollo_["Mutation"], {
          ...
          return external_react_default.a.createElement(Form["a" /* default */], {
            onSubmit: function onSubmit(e) {
              return _this2.handleUpdate(e, updateItem);
            }
