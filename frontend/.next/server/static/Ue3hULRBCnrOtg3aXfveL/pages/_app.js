...
var prodEndpoint = "https://sfits-kola-yoga.herokuapp.com/";
var perPage = 4;
...
var CartItem_CartStyles = external_styled_components_default.a.li.withConfig({
...
var CartItem_CartItem = function CartItem(_ref) {
  ...
  if (!cartItem.item) return external_react_default.a.createElement(CartItem_CartStyles, null, external_react_default.a.createElement("p", null, "This item has been removed from the store.."), external_react_default.a.createElement(components_RemoveFromCart, {
    id: cartItem.id
  }));
  return external_react_default.a.createElement(CartItem_CartStyles, null, external_react_default.a.createElement("img", {
...
var Nav_Nav = function Nav() {
  return external_react_default.a.createElement(User["b" /* default */], null, function (_ref) {
    ...
    return external_react_default.a.createElement(styles_NavStyles, {
      ...
      href: "/signup"
    }, external_react_default.a.createElement("a", null, "Signup / In")));
  });
};
  ...
  Search_createClass(AutoComplete, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(SearchStyles, null, external_react_default.a.createElement(external_downshift_default.a, {
        ...
        }), !_this2.state.items.length && !_this2.state.loading && external_react_default.a.createElement(DropDownItem, null, "No results found for ", inputValue)));
      }));
    }
  }]);
